        ...
        <section className='course-item'>
            <section className="img">
                <section className="img-label">
                    ...
                    <p className='label-text'>فرانت اند</p>
                </section>
                <img src="course01.jpg" alt="تصویر دوره آموزش برنامه نویسی" />
            </section>
            <section className="course-details">
                ...
                <h3>دوره پروژه محور React و Next</h3>
                ...
                <section className="teacher-details">
                    <img src="teacher.jpeg" alt="تصویر مدرس دوره" />
