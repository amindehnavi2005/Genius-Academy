...
function Course({ id, img, status, name, tag, seasonCount, time, teacher, teacherImg, price }) {
    return (
        <section className='course-item'>
            <section className="img">
                <section className="img-label">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-6">
                        <path fill-rule="evenodd" d="M3 6a3 3 0 0 1 3-3h2.25a3 3 0 0 1 3 3v2.25a3 3 0 0 1-3 3H6a3 3 0 0 1-3-3V6Zm9.75 0a3 3 0 0 1 3-3H18a3 3 0 0 1 3 3v2.25a3 3 0 0 1-3 3h-2.25a3 3 0 0 1-3-3V6ZM3 15.75a3 3 0 0 1 3-3h2.25a3 3 0 0 1 3 3V18a3 3 0 0 1-3 3H6a3 3 0 0 1-3-3v-2.25Zm9.75 0a3 3 0 0 1 3-3H18a3 3 0 0 1 3 3V18a3 3 0 0 1-3 3h-2.25a3 3 0 0 1-3-3v-2.25Z" clip-rule="evenodd" />
                    </svg>
                    <p className='label-text'>{tag}</p>
                </section>
                <img src={img} alt="تصویر دوره آموزش برنامه نویسی" />
            </section>
            <section className="course-details">
                <section className='course-status'>
                    ...
                    {status ? (<p>تکمیل شده</p>) : (<p>تکمیل نشده</p>)}
                </section>
                <h3>{name}</h3>
                ...
                <section className="teacher-details">
                    <img src={teacherImg} alt="تصویر مدرس دوره" />
                    <section className='teacher-name'>
                        <p className='text-slate-700 font-medium'>نام مدرس</p>
                        <p className='font-bold'>{teacher}</p>
                    </section>
                    <section className="course-price">
                        {price == 0 ? (<p className='text-xl font-black text-blue-400'>رایگان!</p>) : (<p>{price} <span className='text-slate-600'>تومان</span></p>)}
                    </section>
                </section>
