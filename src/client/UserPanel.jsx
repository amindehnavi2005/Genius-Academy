        ...
        <main className='user-panel'>
            ...
            <section className="cards">
                <Card
                    ...
                    cardTitle={"باقیمانده اشتراک"}
                    cardSubTitle={"عضو ویژه نیستید!"}
                />
                <Card
                    IconCard={
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-6">
                    ...
                    cardTitle={"در حال یادگیری"}
                    cardSubTitle={userCourses.length}
                />
            </section>
            <p className='title'>دوره های در حال یادگیری</p>
                ...
                {userCourses.map((course) => (
                    <section className="course">
                        <Course id={course.id}
                            ...
                            seasonCount={course.courseHeadlines.length}
